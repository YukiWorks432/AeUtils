#pragma once
#ifndef PIXEL8_ARITHMETIC_HPP
#define PIXEL8_ARITHMETIC_HPP
...
inline PF_Pixel8 operator+(const PF_Pixel8 &src, const PF_Pixel8 &x) noexcept {
    return PF_Pixel8{static_cast<A_u_char>(src.alpha + x.alpha),
                     static_cast<A_u_char>(src.red + x.red),
                     static_cast<A_u_char>(src.green + x.green),
                     static_cast<A_u_char>(src.blue + x.blue)};
}
inline PF_Pixel8 operator-(const PF_Pixel8 &src, const PF_Pixel8 &x) noexcept {
    return PF_Pixel8{static_cast<A_u_char>(src.alpha - x.alpha),
                     static_cast<A_u_char>(src.red - x.red),
